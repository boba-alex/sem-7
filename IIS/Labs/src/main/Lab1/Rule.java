...
class Rule {
	...
	static final List<Rule> rules = Arrays.asList(
			new Rule(1, List.of(new Statement(IS_IN_KING_OF_NIGHT_ARMY, Да)),
					new Statement(IS_ALIVE, Нет)),
			new Rule(2, List.of(new Statement(IS_IN_KING_OF_NIGHT_ARMY, Нет)),
					new Statement(IS_ALIVE, Да)),
			new Rule(3, List.of(new Statement(IS_ALIVE, Нет), new Statement(HAS_CROWN, Есть)),
					new Statement(HAS_NAME, КорольНочи)),
			new Rule(4, List.of(new Statement(IS_ALIVE, Нет), new Statement(HAS_CROWN, Нет)),
