...
public class ModelingBasicRandomVariable {
	...
	public static void main(String[] args) {
		...
		//частоты (Observed), количество наблюдений >=50, частота в каждом должна быть больше или равно 5
		int numberOfObservations = 50;
		int numberOfDegreesOfFreedom = numberOfObservations
				- 1; //если мы имеем выборку, по которой уже посчитана сумма частот, то одну из частот всегда можно определить, как разность общего количества и суммой всех остальных.
		int[] v1 = new int[50];
		int[] v2 = new int[50];
