...
DROP TABLE oper_types_to_cur_types;
DROP TABLE operation_types;
DROP TABLE main_operation_types;
DROP TABLE top_operation_types;
...
CREATE TABLE oper_types_to_cur_types (
    id                   INTEGER NOT NULL,
...
ALTER TABLE oper_types_to_cur_types ADD CONSTRAINT oper_types_to_cur_types_pk PRIMARY KEY ( id );
...
ALTER TABLE main_operation_types
    ADD CONSTRAINT top_operation_types_fk FOREIGN KEY ( top_operation_types_id )
        REFERENCES top_operation_types ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE operation_types
    ADD CONSTRAINT main_operation_types_fk FOREIGN KEY ( main_operation_types_id )
        REFERENCES main_operation_types ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE oper_types_to_cur_types
    ADD CONSTRAINT currency_types_fk FOREIGN KEY ( currency_types_id )
        REFERENCES currency_types ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE oper_types_to_cur_types
    ADD CONSTRAINT operation_types_fk FOREIGN KEY ( operation_types_id )
